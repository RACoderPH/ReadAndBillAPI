...
class Schedule extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['sequence', 'sin', 'account_no', 'account_name', 'account_address', 'account_status', 'meter_no', 'connection_date', 'sr_citizen', 'prev_date', 'prev_reading', 'average_usage', 'wb_arrears', 'sf_arrears', 'advance', 'pn_nc', 'pn_nc_count', 'pn_wb', 'pn_wb_count', 'violation', 'reading_date', 'due_date', 'discon_due_date', 'discon_due_date_with_arrears', 'old_meter_usage', 'old_meter_prev_reading', 'old_meter_pres_reading', 'ff_code', 'prev_remarks', 'announcement', 'meter_reader', 'status', 'email', 'soa_type'], 'required'],
            [['sequence', 'account_no', 'account_name', 'account_address', 'account_status', 'meter_no', 'connection_date', 'prev_date', 'reading_date', 'due_date', 'discon_due_date', 'discon_due_date_with_arrears', 'installation_date', 'ff_code', 'prev_remarks', 'announcement'], 'string'],
            [['sr_citizen', 'prev_reading', 'average_usage', 'pn_nc_count', 'pn_wb_count', 'old_meter_usage', 'old_meter_prev_reading', 'old_meter_pres_reading', 'soa_type', 'created_at', 'updated_at'], 'integer'],
