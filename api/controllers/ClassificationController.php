...
use common\models\ClassificationSearch;
 ...
 */
class ClassificationController extends RestBaseController
{
    public $modelClass = 'common\models\Classification';


    //GET all records
    public function actionIndex(){        
        return Classification::find()->all();
    }
    ...
    protected function findModel($id){
        ...
        //Attempt to find the Classification model
        $model = Classification::find()->where(['id' => $id])->one();
    
        if ($model !== null) {
            return $model;
        } else {
            throw new NotFoundHttpException('The requested Classification record does not exist.');
        }
}
}
