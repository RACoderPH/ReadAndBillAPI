 ...
 */
class UnscheduledReadingController extends RestBaseController
{
    public $modelClass = 'common\models\UnscheduledReading';
    ...
    protected function findModel($id)
    {
        ...
        $model = UnscheduledReading::find()->where(['id' => $id])->one();
    ...
    protected function findModelsByDate($date)
    {
        ...
        $model = UnscheduledReading::find()->where(['reading_date' => $date])->all();
