    ...
    <div class="content">
        ...
        <div class="homepage-images">
            <div class="image-card">
                <?= Html::img('@web/images/meter.jpg', ['alt' => 'Meter Reading', 'style' => 'width: 100%; border-radius: 12px;']) ?>
                <p>Efficient and accurate meter reading.</p>
            </div>
            <div class="image-card">
                <?= Html::img('@web/images/customer_care.jpg', ['alt' => 'Customer Service', 'style' => 'width: 100%; border-radius: 12px;']) ?>
                <p>Reliable customer service at your fingertips.</p>
            </div>
            <div class="image-card">
                <?= Html::img('@web/images/water_tank.jpg', ['alt' => 'Water Supply', 'style' => 'width: 100%; border-radius: 12px;']) ?>
